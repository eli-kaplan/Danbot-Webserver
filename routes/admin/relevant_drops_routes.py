...
from utils.database import get_relevant_drop_by_id, update_relevant_drop, delete_relevant_drop, get_tile_triggers, get_tile_types
...
@relevant_drop_routes.route('/delete/<int:relevant_drops_pk>', methods=['POST'])
@admin_required
def delete_relevant_drop_route(relevant_drops_pk):
    ...
    return redirect(url_for('relevant_drop_management.relevant_drop_list'))
